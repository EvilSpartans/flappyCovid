...
class PlayScene extends BaseScene {
    ...
    constructor(config) {
      ...
      create () {
        ...
        // this.anims.create({
        //   key: 'fly',
        //   frames: this.anims.generateFrameNumbers('bird', { start: 1, end: 10}),
        //   frameRate: 10,
        //   repeat: -1
        // })
        // this.bird.play('fly');
      ...
      createBird () {
        this.bird = this.physics.add.sprite(this.config.startPosition.x, this.config.startPosition.y, 'bird')
          ...
          // .setScale(3)
          .setOrigin(0);
        this.bird.setBodySize(this.bird.width, this.bird.height - 14);
      ...
      createPipes () {
        ...
        this.pipes.setBodySize(this.pipes.width - 6, this.pipes.height);

        for (let i = 0; i < PIPES_TO_RENDER; i++) {
          const upperPipe = this.pipes.create(0, 0, 'pipe')
            .setImmovable(true)
            .setOrigin(0, 1);
          const lowerPipe = this.pipes.create(0, 0, 'pipe2')
            .setImmovable(true)
            .setOrigin(0, 0);
